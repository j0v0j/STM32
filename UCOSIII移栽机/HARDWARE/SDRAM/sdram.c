...
void SDRAM_Init(void)
{
    ...
    SDRAM_Handler.Init.SDClockPeriod=FMC_SDRAM_CLOCK_PERIOD_2;           //SDRAM时钟为PLL2_DIVR2/2=256M/2=128M=7.8ns
...
void SDRAM_Initialization_Sequence(SDRAM_HandleTypeDef *hsdram)
{
    ...
    //我们使用的SDRAM刷新周期为64ms,SDCLK=256/2=128Mhz,行数为8192(2^13).
	//所以,COUNT=64*1000*128/8192-20=980
	HAL_SDRAM_ProgramRefreshRate(&SDRAM_Handler,980);	
}	
//SDRAM底层驱动，引脚配置，时钟使能
...
//    RCC_PeriphCLKInitTypeDef SDRAM_ClkInitStruct;
